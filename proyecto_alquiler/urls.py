...
from alquiler.views.alquiler_views import (
    ...
    detalle_alquiler, cancelar_alquiler, reservar_alquiler, generar_acta_devolucion, 
    crear_contrato, firmar_contrato, renovar_contrato, eliminar_alquiler, 
    series_disponibles, editar_alquiler
)

from alquiler.views.pago_views import (
    RegistrarPagoView, PagosPendientesView, GenerarFacturaView, PasarelaPagoView,
    PagosAlquilerView, RegistrarPagoParcialView, PagoDetalleView, ProcesarPagoPasarelaView,
    TotalPagadoAlquilerView, listar_pagos, editar_pago, verificar_estado_pago_alquiler,
    enviar_notificacion_pago, registrar_pago, detalle_pago, generar_factura_pdf,
    pagos_vencidos, pagos_proximos_vencer, cambiar_estado_pago, eliminar_pago,
    reportes_pagos, pagos_parciales, registrar_pago_contra_obligacion
)

from alquiler.views.usuario_views import (
    registro_usuario, salir_sesion, asignar_rol, inicio_sesion, pagina_principal,
    lista_usuarios, editar_usuario, eliminar_usuario, cambiar_estado_usuario,
    cambiar_contrasena, confirmar_eliminar_usuario, detalle_usuario, auditoria_usuario,
    activar_cuenta, crear_rol, lista_roles, editar_rol, eliminar_rol
)
...
core_patterns = [
    ...
    path('pagos/<int:pago_id>/editar/', editar_pago, name='editar_pago'),
